...
if (!isset($_SESSION['login_user'])) {
    ...
    // Di bagian ini, Anda dapat menuliskan kode untuk melakukan operasi lain yang hanya diizinkan untuk pengguna yang sudah login.

    // ... (Kode lain yang hanya boleh diakses oleh pengguna yang sudah login) ...
    // Contoh: Mengeksekusi query ke database, menampilkan data, atau mengolah informasi lainnya.

    // Setelah selesai melakukan operasi yang diizinkan, Anda dapat menambahkan kode HTML dan konten website yang hanya boleh dilihat oleh pengguna yang sudah login.
