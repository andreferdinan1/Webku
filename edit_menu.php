...
// Melakukan query SELECT untuk mengambil data produk dari tabel berdasarkan id_menu tertentu
$ambil = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_menu='$id_menu'");

// Mengambil semua hasil dari query SELECT dan menyimpannya dalam bentuk array asosiatif
