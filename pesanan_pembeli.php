...
// Memeriksa apakah pengguna belum login. Jika belum, arahkan ke halaman login.php
...
<?php
// Memeriksa apakah pesanan kosong atau tidak ada
if (empty($_SESSION["pesanan"]) || !isset($_SESSION["pesanan"])) {
  // Jika pesanan kosong, tampilkan pesan dan arahkan pengguna kembali ke halaman menu_pembeli.php
    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        <thead class="thead-light">
          <tr>
            <th scope="col">No</th><!--scope="col" pada setiap kolom judul, yang berarti bahwa judul tersebut merupakan judul kolom (column header) dari tabel.-->
