    ...
    <form method="POST" action="simpan_register.php">
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="password" class="form-control" id="pass" name="password" placeholder="Masukan Password" minlength="6" maxlength="10" required>
        </div>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-2">
          ...
          <input type="tel" class="form-control" id="telp" name="hp" placeholder="+62" maxlength="13" pattern="(\+62|0|62)8[1-9][0-9]{9,13}$" required>
        </div>
